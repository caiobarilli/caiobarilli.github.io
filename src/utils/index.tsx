/**
 * Return true if the current browser is in dark mode
 * @returns {boolean}
 */
...
/**
 * Receives a string and returns a formatted date
 * @param d string
 * @returns {string}
 */
...
/**
 * Receives a string and returns corresponding flag
 * @param nation string
 * @returns {JSX.Element}
 */
export const svgFlag = (nation: string) => {
